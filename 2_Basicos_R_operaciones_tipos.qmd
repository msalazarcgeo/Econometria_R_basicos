...
*R* como cualquier lenguaje de programación tiene una sintaxis especifica, en este pequeño espacio vamos a repasar dicha sintaxis para hacer operaiones, declarar vasiables, ver los tipos de datos, y ver ciertas funciones básicas que nos haran la vida más facil para programar en *R*.
