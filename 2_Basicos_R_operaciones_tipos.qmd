---
title: "Basicos R Operaciones y tipos de datos"
...
*R* como cualquier lenguaje de programación tiene una sintaxis especifica, en este pequeño espacio vamos a repasar dicha sintaxis para hacer operaciones, declarar vasiables, ver los tipos de datos, y ver ciertas funciones básicas que nos haran la vida más facil para programar en *R*.


Este sitio se pueden ejecutar las celdas de código, en R-Studio se puede ejecutar en la consola de *R* o pueden hacer un Markdown para tomar notas.  
