...
RStudio es un entorno de desarrollo integrado (IDE) que facilita el trabajo con R. Es muy recomendable instalarlo.
 ...
 2. Baja hasta la sección *Install RStudio* y haz clic en el botón "Download RStudio forwindows".
...
*RStudio* es un IDE pensado especificamente para *R* lo que permite que aprender y trabajar dentro con R y *RStudio* sea muy eficiente y amigable. 
...
* ¿ En qué ventana se debe esccribir el comando para la instalación de paquetes en R ?
    * Editor de Scripts
    * Entorno
    * Archivos
    * Visor

* ¿ Como se solicita ayuda desde la consola de R ? 
    * getwd
    * setwd
    * help
    * version

* ¿ Cuál de los siguientes comandos instala la bibliotecca `ggplot2`
