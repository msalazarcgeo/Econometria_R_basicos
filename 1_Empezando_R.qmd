...
*R* es un lenguaje de programación para computación estadistica y visualización de datos. R es un software de código abierto y [software libre](https://en.wikipedia.org/wiki/Free_software). El lenguaje se ha desarrollado desde el principio de los años 90's y ha tenido una evolución constante, recientemente se ha utilizado también para el desarrollo de aplicaciones como la ciencia de datos, el aprendizaje automático o la inteligencia artificial.
...
* Paso 1: Descargar R
    ...
    * Abre tu navegador web y ve al sitio web oficial de CRAN (The Comprehensive R Archive Network): https://cran.r-project.org/
    Imagen de Página principal de CRAN
...
Imagen de Asistente de instalación de R en Windows

macOS:

Imagen de Asistente de instalación de R en macOS
...
Imagen de R en el menú de inicio de Windows
...
RStudio es un entorno de desarrollo integrado (IDE) que facilita el trabajo con R. Es muy recomendable instalarlo.
 ...
 1. Para su instalación abre  en tu navegador web y ve al sitio web oficial de RStudio: [https://rstudio.com/products/rstudio/download/](https://rstudio.com/products/rstudio/download/)

    Imagen de Página de descarga de RStudio

 2. Baja hasta la sección "RStudio Desktop" y haz clic en el botón "Download".
    Imagen de Botón de descarga de RStudio Desktop
 ...
 3. En la siguiente página, busca la sección "Installers for Supported Platforms" y descarga la versión correspondiente a tu sistema operativo:
    * Windows: Haz clic en el archivo .exe.
        ...
        Imagen de Enlace de descarga de RStudio para Windows

    * macOS: Haz clic en el archivo .dmg.

        Imagen de Enlace de descarga de RStudio para macOS

    * Linux : Puedes ver las instrucciones específicas para Debian o Ubuntu o descargar el archivo .deb si es aplicable.

        Imagen de Enlace de descarga de RStudio para Ubuntu
...
4. Una vez que la descarga se complete, abre el archivo ejecutable y sigue las instrucciones del asistente de instalación. Nuevamente, generalmente puedes dejar las opciones predeterminadas.
    ...
    * Windows:
        ...
        Imagen de Asistente de instalación de RStudio en Windows

    * macOS: Arrastra el icono de RStudio a la carpeta de Aplicaciones.

        Imagen de Arrastrar RStudio a la carpeta de Aplicaciones en macOS
...
En el siguinete link pueden enontrar una hoja donde se enuentra resumido muchas de las cosas que se pueden hacer con markdown dentro de r [link](https://raw.githubusercontent.com/rstudio/cheatsheets/main/rmarkdown-2.0.pdf)
...
#| eval: false
```{r echo=FALSE}
# Este código se ejecuta pero no se muestra en el documento final
summary(cars)
``` 
````
